...
// 结点基类
template <typename KeyType, typename DataType> class CNode
{
  public:
    CNode();
    virtual ~CNode();
    ...
    virtual void mergeChild(CNode<KeyType, DataType> *parentNode, CNode<KeyType, DataType> *childNode,
                            int keyIndex) = 0;  // 合并结点
    virtual void clear() = 0;                   // 清空结点，同时会清空结点所包含的子树结点
    virtual void borrowFrom(CNode<KeyType, DataType> *destNode, CNode<KeyType, DataType> *parentNode, int keyIndex,
...
// 内结点
template <typename KeyType, typename DataType> class CInternalNode : public CNode<KeyType, DataType>
{
  public:
    CInternalNode();
...
// 叶子结点
template <typename KeyType, typename DataType> class CLeafNode : public CNode<KeyType, DataType>
{
  public:
    CLeafNode();
    virtual ~CLeafNode();
